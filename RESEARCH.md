...
Carried forward from pass 1 (already itemized in ROADMAP, still valid): A16 hidden-API port, A17 behavior audits, backup verification, restore-fix ports, debloat safety net, wireless-ADB resilience, change auditing, reference states, Dhizuku parity.
