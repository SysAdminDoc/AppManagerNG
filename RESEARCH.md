...
- **Data-loss class in tree**: backup overwrite option still unimplemented (backup/dialog/ TODO since 2020); SessionMonitoringService.java:138 "Wipe memory?" on cryptographic material.
