...
- Source-backed 2026-06-06 audit closures now include DexOpt option parser
  hardening, batch backup flag parser hardening, batch backup import option
  parser hardening, batch freeze option parser hardening, batch network-policy
  option parser hardening, batch permission option parser hardening, batch
  component option parser hardening, batch AppOps option parser hardening,
  batch queue operation parser hardening,
