...
> Last researched: Cycle 155 - 2026-06-07.
...
- Source-backed 2026-06-06/2026-06-07 audit closures now include profile JSON
  UTF-8 export, support bundle preamble redaction, TSV export formula hardening,
  structured export escaping utility, app-list CSV nullable-field hardening,
  app-list XML nullable-field hardening, app-list Markdown escaping, app-list
  CSV formula hardening, logcat export formula hardening, operation history
  export formula hardening, operation history
