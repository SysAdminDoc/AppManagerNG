...
- Source-backed 2026-06-06 audit closures now include SSAID rule value
  ...
  ADB encrypted key-blob length hardening, ADB backup compression flag
  hardening, ADB backup numeric header hardening, manifest intent-filter name
  hardening, manifest intent-filter priority hardening, dynamic shortcut
  ...
  required-field hardening, URI grant flattened
