...
> Last researched: Cycle 194 - 2026-06-07.
...
- Source-backed 2026-06-06/2026-06-07 audit closures now include
  log export attachment-name hardening, saved log subtitle metadata hardening,
  batch installer URI list hardening, hex viewer external metadata hardening,
  code editor external metadata hardening, support-info share intent attachment
  hardening, Activity Interceptor share-details intent hardening, scanner
