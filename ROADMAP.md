...
> Last researched: Cycle 148 - 2026-06-07.
...
- Source-backed 2026-06-06/2026-06-07 audit closures now include app-list CSV
  formula hardening, logcat export formula hardening, operation history export
  formula hardening, operation history replay identity validation, operation
  history target routing,
