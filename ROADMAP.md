...
- Source-backed 2026-06-06 audit closures now include package-name empty-segment
  validation, Hail profile empty-import rejection, external profile package-name
