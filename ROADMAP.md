...
- Source-backed 2026-06-06 audit closures now include logcat numeric field
  parser hardening, Titanium Backup metadata parser hardening, default-app role
  holder parser hardening, selected-user preference parser hardening, rule
  import TSV required-field hardening, URI grant flattened parser hardening,
  Activity Interceptor pasted header hardening, intent empty primitive-array
  ...
  intent extra edit-mode prefill formatting, intent escaped-comma extra
  parsing, intent string null-extra parsing, SAF VFS parent URI mapping, batch
