...
<p align="center">
  <img alt="Version" src="https://img.shields.io/badge/version-0.6.22-blue.svg" />
...
- **v0.6.22** ✅ 2026-08-30. Added a fail-closed shared-UID review for AppOps changes, protected private refresh broadcasts with a signature permission, and closed Log Viewer and startup-guide lifecycle races.
- **v0.6.21** ✅ 2026-08-29. Rebuilt the launcher artwork from the August 2026 icon set. Android now has adaptive and themed assets, plus matching legacy icons.
