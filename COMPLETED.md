...
- [x] **T20-A Perfetto system-trace export**, **T20-B simpleperf CPU profile capture**, **T20-C Memory allocations inspector** — App Details overflow capture actions shipped 2026-05-28, all gated on root/Shizuku/ADB with validated argv via `PrivilegedRunnerArgValidator`; Perfetto duration picker and simpleperf duration/event picker shipped 2026-06-03; pure-function builders/parsers JVM-tested. — *Source: ROADMAP.md*
