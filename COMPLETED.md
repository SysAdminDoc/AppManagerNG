...
- [x] **T19-D Backup duplicate cleaner** — One-Click Ops "Delete duplicate backups" shipped 2026-05-28: keep-newest/keep-oldest via `BackupRetentionPolicy.pruneVersionDuplicates` (11 JVM tests). — *Source: ROADMAP.md*
- [x] **T20-A Perfetto system-trace export**, **T20-B simpleperf CPU profile capture**, **T20-C Memory allocations inspector** — App Details overflow capture actions shipped 2026-05-28, all gated on root/Shizuku/ADB with validated argv via `PrivilegedRunnerArgValidator`; pure-function builders/parsers JVM-tested. — *Source: ROADMAP.md*
