 ...
 * keeps the installed-app list populated (and the About-device settings screen from crashing) when
 * a platform such as Android 17 changes the return type away from {@code ParceledListSlice}.
 */
