...
public class InstallDateOption extends FilterOption {
    ...
    public CharSequence toLocalizedString(@NonNull Context context) {
        SpannableStringBuilder sb = new SpannableStringBuilder(context.getString(R.string.sort_by_installation_date));
        switch (key) {
            case KEY_ALL:
